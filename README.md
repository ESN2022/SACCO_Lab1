...
tout d'abord par décrire l'architecture du système en présentant les composants utilisés et les choix de conception effectués. Ensuite, nous expliquerons 
...
# B. System Architecture
  # 1. QSYS components and their interaction
  # 2. HW Blocks
  # 3. Design Choices
